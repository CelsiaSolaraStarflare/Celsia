...
def merge_text_boxes(text_boxes, max_x_diff=300, max_y_diff=20):
    """
...
def detect_buttons_text(screenshot, max_x_diff=1000, max_y_diff=20):
...
def OCR():
    ...
    button_boxes, text_boxes = find_contours(screenshot, "contours.joblib")
